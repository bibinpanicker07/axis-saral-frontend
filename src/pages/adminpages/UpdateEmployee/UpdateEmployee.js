...
import styles from "../../employeepages/employee/employeeProfile.module.css";
      ...
      <div className={styles.profile}>
        <div className={"card "}>
          ...
          <Link
                ...
                to={`/editEmployee/${params.user}/${params.id}`}
              >

          <button type="submit" class="btn btn-primary" onClick={form}>Update</button>
          </Link>
        </div>
