          ...
          <div class="list-group">
            ...
            <button
              ...
              onClick={(e) => {
                if (designation == "manager") {
                  fetch(
                    `http://localhost:8080/manager/files/salaryslip.pdf`,
                    config
                  ).then((response) => {
            ...
            <button
              ...
              onClick={(e) => {
                if (designation == "manager") {
                  fetch(
                    `http://localhost:8080/manager/files/incrementletter.pdf`,
                    config
                  ).then((response) => {
                    response.blob().then((blob) => {
                      const fileURL = window.URL.createObjectURL(blob);
            ...
            <button
              ...
              onClick={(e) => {
                if (designation == "manager") {
                  fetch(
                    `http://localhost:8080/manager/files/joiningletter.pdf`,
                    config
                  ).then((response) => {
                    response.blob().then((blob) => {
                      const fileURL = window.URL.createObjectURL(blob);
