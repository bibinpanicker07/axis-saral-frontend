import account from './accounts1.png'
...
function Products(){
    ...
    return(
        ...
        <h1 className="img">
      <div Display="flex"><img src={account} height="225px" width="1440px" Display="flex"></img></div>
      ...
      <h1 className="img">
      <div Display="flex"><img src={cards} height="225px" width="1440px" Display="flex"></img></div>
      ...
      <h1 className="img">
      <div Display="flex"><img src={deposit} height="225px" width="1440px" Display="flex"></img></div>
      ...
      <h1 className="img">
      <div Display="flex"><img src={loan} height="225px" width="1440px" Display="flex"></img></div>
      ...
      <h1 className="img">
      <div Display="flex"><img src={insurance} height="225px" width="1440px" Display="flex"></img></div>
      ...
      <h1 className="img">
      <div Display="flex"><img src={invest} height="225px" width="1440px" Display="flex"></img></div>
